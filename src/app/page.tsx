  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gray-950">
     <div className="flex flex-col items-center justify-center text-center">
        <h1 className="md:text-8xl text-6xl font-bold text-white flex mb-4">Movie<span className="text-red-500 flex items-center">Hunt</span></h1>
        <h3 className="md:text-2xl text-xl text-white">Your favourite movies, in all one place!</h3>
     </div>
